...
class Coupons
{
    ...
    private ?CouponsTypes $couponq_types = null;
    ...
    public function getCouponqTypes(): ?CouponsTypes
    {
        return $this->couponq_types;
    }

    public function setCouponqTypes(?CouponsTypes $couponq_types): static
    {
        $this->couponq_types = $couponq_types;
