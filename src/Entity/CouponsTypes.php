...
class CouponsTypes
{
    ...
    #[ORM\OneToMany(mappedBy: 'couponq_types', targetEntity: Coupons::class, orphanRemoval: true)]
    ...
    public function removeCoupon(Coupons $coupon): static
    {
        if ($this->coupons->removeElement($coupon)) {
            ...
            if ($coupon->getCouponqTypes() === $this) {
                $coupon->setCouponqTypes(null);
            }
        }
